...
window.findAndReplaceDOMText = (function() {
	...
	function deprecated(regex, node, replacement, captureGroup, elFilter, elMatchedFilter) {
		...
		var instance = findAndReplaceDOMText(node, {
			...
			filterElements: elFilter,
                        filterMatchedElements : elMatchedFilter
		});
	...
	Finder.prototype = {
		...
		processMatches: function() {
			...
			var node = this.node;
			var elementFilter = this.options.filterElements;
                        var elementMatchedFilter = this.options.filterMatchedElements;
			...
			out: while (true) {
				...
				if (startPortion && endPortion) {
					...
					// match:
                                        if (elementMatchedFilter){elementMatchedFilter(curNode);};
