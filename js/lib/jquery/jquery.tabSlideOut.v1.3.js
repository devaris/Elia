...
(function($){
    $.fn.tabSlideOut = function(callerSettings) {
		...
		//05/12/13 - Added support for HTML objects - Alexis
		/*var whichWidth, whichHeight;
		if ( $(obj).find('object').length) {
			//whichWidth = $(obj).find('object')[0].width;
         //	whichHeight = $(obj).find('object')[0].height;
    	}
		else{
			
			whichHeight = obj.outerHeight();	
		}*/
        whichWidth = obj.outerWidth();
		whichHeight = obj.outerHeight();
        var properties = {
                    //containerWidth: parseInt(obj.outerWidth(), 10) + 'px',
                    //containerHeight: parseInt(obj.outerHeight(), 10) + 'px',
					containerWidth: parseInt(whichWidth, 10) + 'px',
					containerHeight: parseInt(whichHeight, 10) + 'px',
        ...
        var slideIn = function(i) {
            ...
            if (settings.tabLocation === 'top') {
				...
				//$(obj).css("right", "auto")
                obj.eq(i).animate({right: "-30%"}, settings.speed).removeClass('open');
        ...
        var slideOut = function(i) {
            if (settings.tabLocation == 'top') {
				...
				$(obj).css("left", "auto");
                obj.eq(i).animate({right:'0'},  settings.speed).addClass('open');
            } else if (settings.tabLocation == 'bottom') {
