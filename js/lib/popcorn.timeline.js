...
(function ( Popcorn ) {
  ...
  */
  ...
  Popcorn.plugin( "timeline" , function( options ) {
    ...
    contentDiv.innerHTML = "<p><span class='timelineTitle "+options.classTitle+"'>" + options.title + "</span>" + "<span class='timelineText "+options.classText+"'>" + options.text + "</span>" + options.innerHTML + "</p>";
    ...
    return {
      ...
      start: function( event, options ) {
		...
		contentDiv.className += " animated fadeIn";
